...
again and handles the capture as a statement import: rows already in Clatri are
skipped, so sending a period twice adds nothing; transfers between your own
accounts and credit card payments are paired; everything that needs no review
is registered at once. The panel shows the counts. Anything left to review, and
the record of what was registered, is a statement card in Clatri's chat.
